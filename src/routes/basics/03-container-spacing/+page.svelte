...
<div class="container mx-auto">
	<article>
		...
		<p>
			...
			molestiae recusandae accusantium voluptates? Expedita dignissimos amet eveniet dolore nobis
			odio a sunt, maiores quasi. Modi amet quos dolores!
		</p>
	</article>
	<br />

	<!-- Margin -->
	<div class="m-2 bg-slate-100">Margin 2</div>
	<div class="ml-4 bg-slate-100">Margin left 4</div>
	<div class="mr-4 bg-slate-100">Margin right 4</div>
	<div class="mb-2 bg-slate-100">Margin bottom 2</div>
	<div class="mt-2 bg-slate-100">Margin top 2</div>
	<div class="mt-[20px] bg-slate-100">Margin top 20px</div>
	<br />

	<!-- Padding -->
	<div class="bg-slate-100 p-2">Padding 2</div>
	<div class="bg-slate-100 pl-4">Padding left 4</div>
	<div class="bg-slate-100 pr-4">Padding right 4</div>
	<div class="bg-slate-100 pb-2">Padding bottom 2</div>
	<div class="bg-slate-100 pt-2">Padding top 2</div>
	<div class="bg-slate-100 pt-[20px]">Padding top 20px</div>
	<br />
