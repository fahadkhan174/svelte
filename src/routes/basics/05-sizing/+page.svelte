...
<div>
	<!-- Width -->
	<div class="w-12 bg-black text-white">Hello</div>
	<div class="w-24 bg-black text-white">Hello</div>
	<div class="w-48 bg-black text-white">Hello</div>
	<div class="w-96 bg-black text-white">Hello</div>
	<br />

	<!-- Percentages -->
	<div class="w-1/5 bg-emerald-200 text-white">Hello</div>
	<div class="w-1/4 bg-emerald-200 text-white">Hello</div>
	<div class="w-1/3 bg-emerald-200 text-white">Hello</div>
	<div class="w-1/2 bg-emerald-200 text-white">Hello</div>
	<br />

	<!-- Width of the viewport -->
	<!-- <div class="w-screen bg-blue-200 text-white">Hello</div>
	<br /> -->

	<!-- 100% of container -->
	<div class="w-full bg-red-100 text-white">Hello</div>
	<br />

	<!-- Arbitrary width -->
	<div class="w-[150px] bg-orange-100 text-white">Hello</div>
	<br />

	<!-- Max Width -->
	<div class="max-w-sm bg-fuchsia-300 text-white">Hello</div>
	<br />

	<!-- Height (Most of the same options as widths) -->
	<div class="flex items-end">
		<div class="h-24 w-20 bg-orange-300">item 1</div>
		<div class="h-32 w-20 bg-orange-300">item 2</div>
		<div class="h-40 w-20 bg-orange-300">item 3</div>
		<div class="h-48 w-20 bg-orange-300">item 4</div>
		<div class="h-64 w-20 bg-orange-300">item 5</div>
		<div class="h-96 w-20 bg-orange-300">item 5</div>
	</div>
    <br>

	<!-- Full screen height -->
    <div class="h-screen w-20 bg-fuchsia-300 text-white">Hello</div>
	<br />
</div>
