...
<div>
	...
	<div class="columns-4 gap-1">
		<img src={img1} alt="oyo" class="w-full" />
		<img src={img2} alt="lolo" class="w-full" />
		<img src={img3} alt="poko" class="w-full" />
		<img src={img4} alt="chicho" class="w-full" />
	</div>
	<br />
	...
	<!-- Aspect Ratio -->
	<div class="columns-4">
		<img src={img1} alt="oyo" class="aspect-video w-full" />
		<img src={img2} alt="lolo" class="aspect-square w-full" />
		<img src={img3} alt="poko" class="w-full" />
		<img src={img4} alt="chicho" class="w-full" />
	</div>
</div>
